...
const DEFAULT_WEIGHTS = { us: 0.60, canada: 0.25, world: 0.15 }
...
const US_PREFIXES_2L = [
  ...
  'KM','KN','KO','KQ','KR','KS','KT','KU','KV','KW','KX','KY','KZ',
  // W + letter
  'WA','WB','WD','WE','WF','WG','WI','WJ','WK','WM','WN','WO','WQ',
  'WR','WS','WT','WU','WV','WW','WX','WY','WZ',
  // N + letter
  'NA','NB','NC','ND','NE','NF','NG','NI','NJ','NK','NM','NO','NP',
...
const WORLD_PREFIXES = [
  // UK + dependencies
  'G', 'M', 'GW', 'GM', 'GI', 'GU', 'GD', 'GJ',
  // Germany / Austria / Switzerland
  'DL', 'DK', 'DH', 'DJ', 'DF', 'DG', 'OE', 'HB9',
  // Italy / France / Spain / Portugal
  'I', 'IK', 'IZ', 'F', 'EA', 'EB', 'CT',
  // Netherlands / Belgium / Scandinavia
  'PA', 'PD', 'ON', 'OZ', 'SM', 'LA', 'OH',
  // Eastern Europe
  'OK', 'OM', 'SP', 'HA', 'YO', 'YU', '9A', 'S5', 'LZ',
  // Russia / Ukraine
  'RA', 'RW', 'RV', 'RZ', 'UR', 'UT', 'UA',
  // Asia / Oceania / South America
  'JA', 'JE', 'JF', 'JH', 'JR', 'BG', 'BH', 'HL', 'BV',
  'VK', 'ZL', 'PY', 'LU', 'CE', 'CX',
]
...
export function randomCanadianCallsign(rng: () => number = Math.random): string {
