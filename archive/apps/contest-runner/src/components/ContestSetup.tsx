        ...
        <div className="setup-section">
          ...
          <div className="contest-type-selector">
            ...
            >
              ...
              <span className="contest-desc">
                Exchange: 5NN + Serial Number
              </span>
            </button>
            <button
            ...
            <>
              ...
              <div className="setup-field">
                ...
                <input
                  ...
                  value={myNumber}
                  onChange={(e) =>
                    onMyNumberChange(e.target.value.toUpperCase())
                  }
                ...
                <span className="field-hint">
                  CWOps member number (e.g., 1234) or state/country (e.g., CA,
                  G)
                </span>
              </div>
            </>
